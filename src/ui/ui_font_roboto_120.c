...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0x44, 0x44, 0xdf, 0xff, 0xff, 0xff, 0xff, 0xf8,
    0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 1089, .box_w = 60, .box_h = 63, .ofs_x = 4, .ofs_y = 9},
    {.bitmap_index = 1890, .adv_w = 531, .box_w = 29, .box_h = 9, .ofs_x = 2, .ofs_y = 32},
    {.bitmap_index = 2021, .adv_w = 506, .box_w = 14, .box_h = 14, .ofs_x = 8, .ofs_y = -1},
    {.bitmap_index = 2119, .adv_w = 1079, .box_w = 55, .box_h = 88, .ofs_x = 6, .ofs_y = -1},
    {.bitmap_index = 4539, .adv_w = 1079, .box_w = 33, .box_h = 87, .ofs_x = 10, .ofs_y = 0},
    {.bitmap_index = 5975, .adv_w = 1079, .box_w = 58, .box_h = 87, .ofs_x = 5, .ofs_y = 0},
    {.bitmap_index = 8498, .adv_w = 1079, .box_w = 55, .box_h = 88, .ofs_x = 5, .ofs_y = -1},
    {.bitmap_index = 10918, .adv_w = 1079, .box_w = 62, .box_h = 86, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 13584, .adv_w = 1079, .box_w = 54, .box_h = 87, .ofs_x = 9, .ofs_y = -1},
    {.bitmap_index = 15933, .adv_w = 1079, .box_w = 55, .box_h = 88, .ofs_x = 7, .ofs_y = -1},
    {.bitmap_index = 18353, .adv_w = 1079, .box_w = 59, .box_h = 86, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 20890, .adv_w = 1079, .box_w = 55, .box_h = 88, .ofs_x = 6, .ofs_y = -1},
    {.bitmap_index = 23310, .adv_w = 1079, .box_w = 55, .box_h = 88, .ofs_x = 5, .ofs_y = 0},
    {.bitmap_index = 25730, .adv_w = 1250, .box_w = 66, .box_h = 89, .ofs_x = 7, .ofs_y = -1},
    {.bitmap_index = 28667, .adv_w = 717, .box_w = 31, .box_h = 31, .ofs_x = 7, .ofs_y = 57}
};
